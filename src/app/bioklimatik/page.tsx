...
import { ArrowRight, Phone, ChevronDown, Shield, Award, Sparkles, Leaf, Sun, Droplets, X, Wind } from "lucide-react";
import Header from "@/components/Header";
import Footer from "@/components/Footer";

// Bioklimatik kategorisindeki proje görselleri
const bioklimatikProjects = [
  { 
    src: "/images/projects/94ceb7d1-7e61-4612-bf9c-6a2623cd45fe.jpg", 
    title: "Modern Bioklimatik Tavan",
    alt: "Modern tasarım bioklimatik tavan projesi"
  },
  { 
    src: "/images/projects/a2a54c7a-f684-47ad-861a-3b5c02a4fd94.jpg", 
    title: "Panoramik Bioklimatik Tavan",
    alt: "Panoramik görünümlü bioklimatik tavan"
  },
  { 
    src: "/images/projects/a77c368b-8476-4a92-a01c-6c08f705b980.jpg", 
    title: "Villa Bioklimatik Tavan",
    alt: "Villa için özel tasarım bioklimatik tavan"
  },
  { 
    src: "/images/projects/cf3777cd-a53c-44d5-aa2b-f0562621a607.jpg", 
    title: "Lüks Bioklimatik Tavan",
    alt: "Lüks bioklimatik tavan projesi"
  },
  { 
    src: "/images/projects/df5971d9-c105-4b7e-bbe5-17f182ae8bc8.jpg", 
    title: "Bahçe Entegrasyonlu Bioklimatik",
    alt: "Bahçe ile entegre bioklimatik tavan"
  },
  { 
    src: "/images/projects/e327a0bb-698e-448b-94e1-126291cb38be.jpg", 
    title: "Premium Bioklimatik Tavan",
    alt: "Premium kalite bioklimatik tavan sistemi"
  },
];
...
const advantages = [
  {
    ...
    imageAlt: "Modern bioklimatik tavan tasarımı",
    title: "Doğal Havalandırma Sistemi",
    content: "Bioklimatik tavan sisteminiz, ayarlanabilir lameller sayesinde doğal havalandırma sağlar. Lameller açıldığında temiz hava akışı oluşur, kapandığında korunaklı bir alan yaratır. Güneş ışığını kontrol ederken aynı zamanda hava sirkülasyonu sağlar. Modern teknoloji ile doğal ve sağlıklı bir yaşam alanı yaratın.",
  },
  {
    image: "/images/projects/a2a54c7a-f684-47ad-861a-3b5c02a4fd94.jpg",
    imageAlt: "Panoramik bioklimatik tavan görünümü",
    title: "Yıl Boyu Kullanılabilir Yaşam Alanı",
    content: "Bioklimatik tavan sisteminiz, yılın 12 ayı kullanabileceğiniz ekstra bir yaşam alanı kazandırır. Kış aylarında kapalı konumda güneşten faydalanırken, yaz aylarında açık konumda doğal havalandırma ile serin bir ortam oluşturabilirsiniz. Ayarlanabilir lameller sayesinde ışık, gölge ve hava kontrolü tamamen sizin elinizde.",
  },
  {
    image: "/images/projects/a77c368b-8476-4a92-a01c-6c08f705b980.jpg",
    imageAlt: "Lüks bioklimatik tavan iç mekan",
    title: "Evinizin Değerini Artırır",
    content: "Profesyonel olarak tasarlanmış ve montaj edilmiş bir bioklimatik tavan sistemi, evinizin değerini önemli ölçüde artırır. Emlak değeri artışı yanında, yaşam kalitenizi de yükseltir. Yatırım olarak düşünüldüğünde, bioklimatik tavan uzun vadede size kazanç sağlar. Modern ve teknolojik görünümüyle evinizin çekiciliğini artırır.",
  },
  {
    image: "/images/projects/df5971d9-c105-4b7e-bbe5-17f182ae8bc8.jpg",
    imageAlt: "Bahçe entegrasyonlu bioklimatik tavan",
    title: "Doğayla İç İçe Yaşam",
    content: "Bioklimatik tavan sisteminiz, evinizle bahçeniz arasında köprü görevi görür. Doğal havalandırma sayesinde temiz havayı içeriye taşır. Açık konumda gökyüzünü izleyebilir, kapalı konumda korunaklı bir alan oluşturabilirsiniz. Doğayı içeriye taşıyarak, her mevsim yeşilliklerle çevrili bir ortam yaratır.",
  },
];

const faqData = [
  {
    question: "Bioklimatik tavan fiyatları ne kadar?",
    answer: "Bioklimatik tavan fiyatları, projenin büyüklüğüne, kullanılan malzemeye, motor tipine ve özel tasarım gereksinimlerine göre değişiklik gösterir. Standart bir bioklimatik tavan için fiyat aralığı 80.000 TL ile 350.000 TL arasında değişebilir. Detaylı fiyat teklifi için ücretsiz keşif hizmetimizden yararlanabilirsiniz.",
  },
  {
    question: "Bioklimatik tavan montajı ne kadar sürer?",
    answer: "Montaj süresi, projenin büyüklüğüne ve karmaşıklığına bağlı olarak 2-4 hafta arasında değişir. Standart bir bioklimatik tavan montajı genellikle 2-3 hafta içinde tamamlanır. Özel tasarım ve teknoloji entegrasyonu gerektiren projelerde bu süre biraz daha uzayabilir.",
  },
  {
    question: "Bioklimatik tavan hangi malzemelerden yapılır?",
    answer: "Bioklimatik tavan sistemlerimiz, 6063-T6 alaşımlı özel ekstrüzyon alüminyum profillerden üretilir. Lameller alüminyum veya alüminyum-polyester kaplamalı malzemeden yapılır. Motorlar Avrupa standartlarında, sessiz ve güvenilir sistemlerdir. Tüm malzemelerimiz TSE ve CE belgeli, 25 yıl garanti kapsamındadır.",
  },
  {
    question: "Bioklimatik tavan nasıl çalışır?",
    answer: "Bioklimatik tavan sistemleri, ayarlanabilir lameller ile çalışır. Lameller açıldığında doğal havalandırma sağlar, kapandığında korunaklı bir alan oluşturur. Elektrikli motorlar ile uzaktan kumanda, akıllı telefon uygulaması veya duvar anahtarı ile kontrol edilebilir. Güneş sensörleri sayesinde otomatik olarak güneşe göre ayarlanır. Yağmur sensörleri ile yağmur başladığında otomatik kapanır.",
  },
  {
    question: "Bioklimatik tavan için ruhsat gerekir mi?",
    answer: "Bioklimatik tavan için genellikle ruhsat gerekmez, ancak belediyenizin düzenlemelerine göre değişiklik gösterebilir. Projeniz için gerekli tüm izin ve ruhsat işlemlerinde size yardımcı oluyoruz.",
  },
  {
    question: "Bioklimatik tavan bakımı nasıl yapılır?",
    answer: "Alüminyum profillerin bakımı çok kolaydır. Düzenli olarak su ve sabunlu bezle temizlenmesi yeterlidir. Lamellerin temiz tutulması önemlidir. Motor sistemleri yılda bir kez profesyonel kontrol ve bakım gerektirir. Sensörlerin düzenli kontrolü önerilir. Tüm bakım işlemleri için teknik destek ekibimiz hizmetinizdedir.",
  },
];

export default function BioklimatikPage() {
  ...
  const jsonLd = {
    ...
    "@type": "Service",
    "serviceType": "Bioklimatik Tavan Sistemleri",
    "provider": {
      "@type": "LocalBusiness",
      "name": "Kış Bahçesi",
      "address": {
            ...
            <div className="mx-auto max-w-7xl px-4 md:px-6">
              <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
                ...
                >
                  ...
                  >
                    Premium Bioklimatik Tavan Sistemleri
                  </motion.div>
                  <motion.h1
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                  ...
                  >
                    15+ yıllık tecrübemiz ve 2500+ tamamlanan projemizle, evinize değer katacak modern bioklimatik tavan sistemleri sunuyoruz. Doğal havalandırma, ayarlanabilir lameller ve uzman montaj ekibimizle hayalinizdeki yaşam alanını gerçeğe dönüştürüyoruz.
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                  ...
                  >
                    <Link
                      href="https://wa.me/905333593466?text=Bioklimatik%20tavan%20hakkında%20bilgi%20almak%20istiyorum"
                      target="_blank"
                ...
                >
                  ...
                  >
                    <div className="rounded-2xl bg-white p-4 shadow-xl border border-teal-100">
                      <Wind className="h-8 w-8 text-teal-900" />
                    </div>
                  </motion.div>
                </motion.div>
              </div>
            ...
            <div className="mx-auto max-w-7xl px-4 md:px-6">
              ...
              >
                ...
                <h2 className="mb-4 text-3xl font-bold text-gray-900 md:text-4xl">
                  Neden Bioklimatik Tavan?
                </h2>
                <p className="mx-auto max-w-2xl text-lg text-gray-600">
                  Bioklimatik tavan sisteminiz, evinize değer katan ve yaşam kalitenizi artıran özel bir alan
                </p>
              </motion.div>

              <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                {[
                  { icon: Wind, title: "Doğal Havalandırma", desc: "Ayarlanabilir lameller ile doğal hava akışı" },
                  { icon: Sun, title: "Işık Kontrolü", desc: "Lameller ile ışık ve gölge kontrolü" },
                  { icon: Droplets, title: "Enerji Tasarrufu", desc: "Doğal havalandırma ile enerji tasarrufu" },
            ...
            <div className="mx-auto max-w-7xl px-4 md:px-6">
              ...
              >
                ...
                <p className="mx-auto max-w-2xl text-lg text-gray-600 md:text-xl">
                  15+ yıllık tecrübemizle tamamladığımız başarılı bioklimatik tavan projelerinden örnekler
                </p>
              </motion.div>

              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {bioklimatikProjects.map((project, index) => (
                  <motion.div
                    key={project.title}
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                >
                  ...
                  <div className="relative w-full h-[90vh] bg-gray-100">
                    <Image
                      src={bioklimatikProjects[selectedProject].src}
                      alt={bioklimatikProjects[selectedProject].alt}
                      fill
          ...
          <section className="py-16 md:py-24 bg-gradient-to-b from-white via-teal-50/30 to-white">
            <div className="mx-auto max-w-4xl px-4 md:px-6">
              ...
              >
                ...
                <p className="mx-auto max-w-2xl text-lg text-gray-600 md:text-xl">
                  Bioklimatik tavan hakkında merak ettikleriniz ve cevapları
                </p>
              </motion.div>
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <Link
                    href="https://wa.me/905333593466?text=Bioklimatik%20tavan%20hakkında%20soru%20sormak%20istiyorum"
                    target="_blank"
            ...
            <div className="relative mx-auto max-w-5xl px-4 text-center md:px-6">
              ...
              >
                ...
                <h2 className="mb-6 text-4xl font-bold text-white md:text-5xl lg:text-6xl">
                  Hayalinizdeki Bioklimatik Tavana{" "}
