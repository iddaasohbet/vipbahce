              ...
              <div className="space-y-8">
                ...
                <div className="mb-8 rounded-2xl border border-gray-200 bg-gradient-to-br from-gray-50 to-white p-6">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Bu gizlilik politikası, Kış Bahçesi olarak kişisel verilerinizi nasıl topladığımız, 
                    kullandığımız, sakladığımız ve koruduğumuz hakkında bilgi vermektedir.
                  </p>
                </div>
                {/* Section 1 */}
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed mb-4">
                    ...
                    kişisel verileriniz aşağıdaki şekilde işlenmektedir:
                  </p>
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-gray-700">
                    ...
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="h-5 w-5 text-teal-900 mt-0.5 flex-shrink-0" />
                      <span><strong>İletişim Bilgileri:</strong> Telefon numarası, e-posta adresi, adres bilgisi</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="h-5 w-5 text-teal-900 mt-0.5 flex-shrink-0" />
                      <span><strong>Müşteri İşlem Bilgileri:</strong> Talep edilen hizmet bilgileri, proje detayları</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="h-5 w-5 text-teal-900 mt-0.5 flex-shrink-0" />
                      <span><strong>İşlem Güvenliği Bilgileri:</strong> IP adresi, çerez bilgileri, tarayıcı bilgileri</span>
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  <div className="mb-4 flex items-center gap-3">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900">3. Kişisel Verilerin İşlenme Amaçları</h2>
                  </div>
                  <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  <ul className="space-y-2 text-gray-700">
                    ...
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="h-5 w-5 text-teal-900 mt-0.5 flex-shrink-0" />
                      <span>Teklif hazırlamak ve sözleşme süreçlerini yürütmek</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="h-5 w-5 text-teal-900 mt-0.5 flex-shrink-0" />
                ...
                <div>
                  <div className="mb-4 flex items-center gap-3">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900">4. Kişisel Verilerin Korunması</h2>
                  </div>
                  <p className="text-gray-700 leading-relaxed mb-4">
                    Kişisel verilerinizin güvenliği bizim için önceliklidir. Verilerinizi korumak için 
                    teknik ve idari güvenlik önlemleri alıyoruz:
                  </p>
                  <ul className="space-y-2 text-gray-700">
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="h-5 w-5 text-teal-900 mt-0.5 flex-shrink-0" />
                ...
                <div>
                  <div className="mb-4 flex items-center gap-3">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900">5. Kişisel Verilerin Paylaşılması</h2>
                  </div>
                  <p className="text-gray-700 leading-relaxed mb-4">
                    Kişisel verileriniz, yasal zorunluluklar dışında üçüncü kişilerle paylaşılmamaktadır. 
                    Ancak, hizmetlerimizi sunabilmek için aşağıdaki durumlarda verileriniz paylaşılabilir:
                  </p>
                  <ul className="space-y-2 text-gray-700">
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="h-5 w-5 text-teal-900 mt-0.5 flex-shrink-0" />
                    ...
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="h-5 w-5 text-teal-900 mt-0.5 flex-shrink-0" />
                      <span>Hizmet sağlayıcılarımız (hosting, e-posta servisleri vb.)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="h-5 w-5 text-teal-900 mt-0.5 flex-shrink-0" />
                ...
                <div>
                  <div className="mb-4 flex items-center gap-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-teal-100">
                      <CheckCircle2 className="h-5 w-5 text-teal-900" />
                    </div>
                    <h2 className="text-2xl font-bold text-gray-900">6. KVKK Kapsamındaki Haklarınız</h2>
                  </div>
                  <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  <ul className="space-y-2 text-gray-700">
                    ...
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="h-5 w-5 text-teal-900 mt-0.5 flex-shrink-0" />
                      <span>İşlenen verilerin münhasıran otomatik sistemler ile analiz edilmesi suretiyle kişinin kendisi aleyhine bir sonucun ortaya çıkmasına itiraz etme</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="h-5 w-5 text-teal-900 mt-0.5 flex-shrink-0" />
                      <span>Kanuna aykırı olarak işlenmesi sebebiyle zarara uğraması halinde zararın giderilmesini talep etme</span>
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  <div className="mb-4 flex items-center gap-3">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900">7. Çerezler (Cookies)</h2>
                  </div>
                  <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <div>
                  <div className="mb-4 flex items-center gap-3">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900">8. İletişim</h2>
                  </div>
                  <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Bu gizlilik politikası zaman zaman güncellenebilir. Yapılan değişiklikler web sitemizde 
                    yayınlanarak sizlere duyurulacaktır. Önemli değişiklikler için ek olarak e-posta ile 
