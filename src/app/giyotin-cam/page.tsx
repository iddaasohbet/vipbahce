...
import { ArrowRight, Phone, ChevronDown, Shield, Award, Sparkles, Leaf, Sun, Droplets, X, Move } from "lucide-react";
import Header from "@/components/Header";
import Footer from "@/components/Footer";

// Giyotin cam kategorisindeki proje görselleri
const giyotinCamProjects = [
  { 
    src: "/images/projects/110810ab-64f2-4728-a238-2a003508a302.jpg", 
    title: "Modern Giyotin Cam",
    alt: "Modern tasarım giyotin cam projesi"
  },
  { 
    src: "/images/projects/23423c76-bf9b-4e4d-9d1a-c6be73a68a50.jpg", 
    title: "Panoramik Giyotin Cam",
    alt: "Panoramik görünümlü giyotin cam"
  },
  { 
    src: "/images/projects/24929279-47c0-4aad-b65f-f7ba24e86f5d.jpg", 
    title: "Villa Giyotin Cam",
    alt: "Villa için özel tasarım giyotin cam"
  },
  { 
    src: "/images/projects/3ad4c9ba-779e-4b89-9442-42e1be96dfbf.jpg", 
    title: "Lüks Giyotin Cam",
    alt: "Lüks giyotin cam projesi"
  },
  { 
    src: "/images/projects/615a9bb3-45f2-42e9-9a4f-dae84b4f64de.jpg", 
    title: "Bahçe Entegrasyonlu Giyotin Cam",
    alt: "Bahçe ile entegre giyotin cam"
  },
  { 
    src: "/images/projects/72d1c386-41de-4199-8b88-d1e92457f134.jpg", 
    title: "Premium Giyotin Cam",
    alt: "Premium kalite giyotin cam sistemi"
  },
];
...
const advantages = [
  {
    ...
    imageAlt: "Modern giyotin cam tasarımı",
    title: "Yukarı-Aşağı Açılan Sistem",
    content: "Giyotin cam sisteminiz, cam panellerin yukarı ve aşağı hareket etmesi ile çalışır. Bu sayede tamamen açık bir alan yaratabilir veya istediğiniz yüksekliğe kadar açık bırakabilirsiniz. Motorlu sistem sayesinde tek dokunuşla kontrol edebilirsiniz. Modern teknoloji ile esnek ve konforlu yaşam alanları yaratın.",
  },
  {
    image: "/images/projects/23423c76-bf9b-4e4d-9d1a-c6be73a68a50.jpg",
    imageAlt: "Panoramik giyotin cam görünümü",
    title: "Yıl Boyu Kullanılabilir Yaşam Alanı",
    content: "Giyotin cam sisteminiz, yılın 12 ayı kullanabileceğiniz ekstra bir yaşam alanı kazandırır. Kış aylarında kapalı konumda korunaklı bir alan oluştururken, yaz aylarında tamamen açık konumda doğayla iç içe vakit geçirebilirsiniz. İstediğiniz yüksekliğe kadar açarak kısmi açıklık da sağlayabilirsiniz.",
  },
  {
    image: "/images/projects/3ad4c9ba-779e-4b89-9442-42e1be96dfbf.jpg",
    imageAlt: "Lüks giyotin cam iç mekan",
    title: "Evinizin Değerini Artırır",
    content: "Profesyonel olarak tasarlanmış ve montaj edilmiş bir giyotin cam sistemi, evinizin değerini önemli ölçüde artırır. Emlak değeri artışı yanında, yaşam kalitenizi de yükseltir. Yatırım olarak düşünüldüğünde, giyotin cam uzun vadede size kazanç sağlar. Modern ve teknolojik görünümüyle evinizin çekiciliğini artırır.",
  },
  {
    image: "/images/projects/615a9bb3-45f2-42e9-9a4f-dae84b4f64de.jpg",
    imageAlt: "Bahçe entegrasyonlu giyotin cam",
    title: "Doğayla İç İçe Yaşam",
    content: "Giyotin cam sisteminiz, evinizle bahçeniz arasında köprü görevi görür. Tamamen açık konumda doğayla iç içe olabilir, kapalı konumda korunaklı bir alan oluşturabilirsiniz. İstediğiniz yüksekliğe kadar açarak kısmi açıklık sağlayabilirsiniz. Panoramik görünüm sayesinde manzaranın her köşesini net bir şekilde görebilirsiniz.",
  },
];

const faqData = [
  {
    question: "Giyotin cam fiyatları ne kadar?",
    answer: "Giyotin cam fiyatları, projenin büyüklüğüne, kullanılan malzemeye, cam tipine, motor tipine ve özel tasarım gereksinimlerine göre değişiklik gösterir. Standart bir giyotin cam için fiyat aralığı 50.000 TL ile 200.000 TL arasında değişebilir. Detaylı fiyat teklifi için ücretsiz keşif hizmetimizden yararlanabilirsiniz.",
  },
  {
    question: "Giyotin cam montajı ne kadar sürer?",
    answer: "Montaj süresi, projenin büyüklüğüne ve karmaşıklığına bağlı olarak 1-3 hafta arasında değişir. Standart bir giyotin cam montajı genellikle 1-2 hafta içinde tamamlanır. Özel tasarım ve teknoloji entegrasyonu gerektiren projelerde bu süre biraz daha uzayabilir.",
  },
  {
    question: "Giyotin cam hangi malzemelerden yapılır?",
    answer: "Giyotin cam sistemlerimiz, 6063-T6 alaşımlı özel ekstrüzyon alüminyum profillerden üretilir. Cam olarak temperli cam veya çift cam (izolasyonlu) kullanılır. Motorlar Avrupa standartlarında, sessiz ve güvenilir sistemlerdir. Tüm malzemelerimiz TSE ve CE belgeli, 25 yıl garanti kapsamındadır.",
  },
  {
    question: "Giyotin cam nasıl çalışır?",
    answer: "Giyotin cam sistemleri, cam panellerin yukarı ve aşağı hareket etmesi ile çalışır. Elektrikli motorlar ile uzaktan kumanda, akıllı telefon uygulaması veya duvar anahtarı ile kontrol edilebilir. Sistem tamamen açılabilir veya kapanabilir. İstediğiniz yüksekliğe kadar açık bırakabilirsiniz. Güvenlik sensörleri ile güvenli kullanım sağlanır.",
  },
  {
    question: "Giyotin cam için ruhsat gerekir mi?",
    answer: "Giyotin cam için genellikle ruhsat gerekmez, ancak belediyenizin düzenlemelerine göre değişiklik gösterebilir. Projeniz için gerekli tüm izin ve ruhsat işlemlerinde size yardımcı oluyoruz.",
  },
  {
    question: "Giyotin cam bakımı nasıl yapılır?",
    answer: "Alüminyum profillerin bakımı çok kolaydır. Düzenli olarak su ve sabunlu bezle temizlenmesi yeterlidir. Cam yüzeyler için cam temizleyici kullanabilirsiniz. Motor sistemleri yılda bir kez profesyonel kontrol ve bakım gerektirir. Ray sistemlerinin temiz tutulması önemlidir. Tüm bakım işlemleri için teknik destek ekibimiz hizmetinizdedir.",
  },
];

export default function GiyotinCamPage() {
  ...
  const jsonLd = {
    ...
    "@type": "Service",
    "serviceType": "Giyotin Cam Sistemleri",
    "provider": {
      "@type": "LocalBusiness",
      "name": "Kış Bahçesi",
      "address": {
            ...
            <div className="mx-auto max-w-7xl px-4 md:px-6">
              <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
                ...
                >
                  ...
                  >
                    Premium Giyotin Cam Sistemleri
                  </motion.div>
                  <motion.h1
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                  ...
                  >
                    15+ yıllık tecrübemiz ve 2500+ tamamlanan projemizle, evinize değer katacak modern giyotin cam sistemleri sunuyoruz. Yukarı-aşağı açılan sistem, motorlu kontrol ve uzman montaj ekibimizle hayalinizdeki yaşam alanını gerçeğe dönüştürüyoruz.
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                  ...
                  >
                    <Link
                      href="https://wa.me/905333593466?text=Giyotin%20cam%20hakkında%20bilgi%20almak%20istiyorum"
                      target="_blank"
                ...
                >
                  ...
                  >
                    <div className="rounded-2xl bg-white p-4 shadow-xl border border-teal-100">
                      <Move className="h-8 w-8 text-teal-900" />
                    </div>
                  </motion.div>
                </motion.div>
              </div>
            ...
            <div className="mx-auto max-w-7xl px-4 md:px-6">
              ...
              >
                ...
                <p className="mx-auto max-w-2xl text-lg text-gray-600">
                  Giyotin cam sisteminiz, evinize değer katan ve yaşam kalitenizi artıran özel bir alan
                </p>
              </motion.div>

              <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                {[
                  { icon: Move, title: "Yukarı-Aşağı Açılım", desc: "Cam panellerin yukarı ve aşağı hareket etmesi" },
            ...
            <div className="mx-auto max-w-7xl px-4 md:px-6">
              ...
              >
                ...
                <p className="mx-auto max-w-2xl text-lg text-gray-600 md:text-xl">
                  15+ yıllık tecrübemizle tamamladığımız başarılı giyotin cam projelerinden örnekler
                </p>
              </motion.div>

              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {giyotinCamProjects.map((project, index) => (
                  <motion.div
                    key={project.title}
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                >
                  ...
                  <div className="relative w-full h-[90vh] bg-gray-100">
                    <Image
                      src={giyotinCamProjects[selectedProject].src}
                      alt={giyotinCamProjects[selectedProject].alt}
                      fill
          ...
          <section className="py-16 md:py-24 bg-gradient-to-b from-white via-teal-50/30 to-white">
            <div className="mx-auto max-w-4xl px-4 md:px-6">
              ...
              >
                ...
                <p className="mx-auto max-w-2xl text-lg text-gray-600 md:text-xl">
                  Giyotin cam hakkında merak ettikleriniz ve cevapları
                </p>
              </motion.div>
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <Link
                    href="https://wa.me/905333593466?text=Giyotin%20cam%20hakkında%20soru%20sormak%20istiyorum"
                    target="_blank"
