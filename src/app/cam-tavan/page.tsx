            ...
            <div className="mx-auto max-w-7xl px-4 md:px-6">
              <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
                ...
                >
                  ...
                  >
                    <Link
                      href="https://wa.me/905425263466?text=Cam%20tavan%20hakkında%20bilgi%20almak%20istiyorum"
                      target="_blank"
            ...
            <div className="mx-auto max-w-4xl px-4 md:px-6">
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <Link
                    href="https://wa.me/905425263466?text=Cam%20tavan%20hakkında%20soru%20sormak%20istiyorum"
                    target="_blank"
