...
// Hebeshiebe kategorisindeki proje görselleri
const hebeshiebeProjects = [
  { 
    src: "/images/projects/e672ed00-ee93-49eb-8ff6-5f95772ae59e.jpg", 
    title: "Modern Hebeshiebe",
    alt: "Modern tasarım hebeshiebe projesi"
  },
  { 
    src: "/images/projects/7c30fee6-861f-4949-bd08-95dd9f9a16f2.jpg", 
    title: "Panoramik Hebeshiebe",
    alt: "Panoramik görünümlü hebeshiebe"
  },
  { 
    src: "/images/projects/7920ba6f-b67e-47a0-9b09-5760f7bd139d.jpg", 
    title: "Villa Hebeshiebe",
    alt: "Villa için özel tasarım hebeshiebe"
  },
  { 
    src: "/images/projects/110810ab-64f2-4728-a238-2a003508a302.jpg", 
    title: "Lüks Hebeshiebe",
    alt: "Lüks hebeshiebe projesi"
  },
  { 
    src: "/images/projects/23423c76-bf9b-4e4d-9d1a-c6be73a68a50.jpg", 
    title: "Bahçe Entegrasyonlu Hebeshiebe",
    alt: "Bahçe ile entegre hebeshiebe"
  },
  { 
    src: "/images/projects/24929279-47c0-4aad-b65f-f7ba24e86f5d.jpg", 
    title: "Premium Hebeshiebe",
    alt: "Premium kalite hebeshiebe sistemi"
  },
];
...
const advantages = [
  ...
  },
  {
    ...
    imageAlt: "Lüks hebeshiebe iç mekan",
    title: "Evinizin Değerini Artırır",
    content: "Profesyonel olarak tasarlanmış ve montaj edilmiş bir hebeshiebe sistemi, evinizin değerini önemli ölçüde artırır. Emlak değeri artışı yanında, yaşam kalitenizi de yükseltir. Yatırım olarak düşünüldüğünde, hebeshiebe uzun vadede size kazanç sağlar. Modern ve teknolojik görünümüyle evinizin çekiciliğini artırır.",
  },
  {
    image: "/images/projects/23423c76-bf9b-4e4d-9d1a-c6be73a68a50.jpg",
    imageAlt: "Bahçe entegrasyonlu hebeshiebe",
    title: "Doğayla İç İçe Yaşam",
    content: "Hebeshiebe sisteminiz, evinizle bahçeniz arasında köprü görevi görür. Tamamen açık konumda doğayla iç içe olabilir, kapalı konumda korunaklı bir alan oluşturabilirsiniz. İstediğiniz yüksekliğe kadar açarak kısmi açıklık sağlayabilirsiniz. Panoramik görünüm sayesinde manzaranın her köşesini net bir şekilde görebilirsiniz.",
  },
];

const faqData = [
  {
    question: "Hebeshiebe fiyatları ne kadar?",
    answer: "Hebeshiebe fiyatları, projenin büyüklüğüne, kullanılan malzemeye, cam tipine, motor tipine ve özel tasarım gereksinimlerine göre değişiklik gösterir. Standart bir hebeshiebe için fiyat aralığı 55.000 TL ile 220.000 TL arasında değişebilir. Detaylı fiyat teklifi için ücretsiz keşif hizmetimizden yararlanabilirsiniz.",
  },
  {
    question: "Hebeshiebe montajı ne kadar sürer?",
    answer: "Montaj süresi, projenin büyüklüğüne ve karmaşıklığına bağlı olarak 1-3 hafta arasında değişir. Standart bir hebeshiebe montajı genellikle 1-2 hafta içinde tamamlanır. Özel tasarım ve teknoloji entegrasyonu gerektiren projelerde bu süre biraz daha uzayabilir.",
  },
  {
    question: "Hebeshiebe hangi malzemelerden yapılır?",
    answer: "Hebeshiebe sistemlerimiz, 6063-T6 alaşımlı özel ekstrüzyon alüminyum profillerden üretilir. Cam olarak temperli cam veya çift cam (izolasyonlu) kullanılır. Motorlar Avrupa standartlarında, sessiz ve güvenilir sistemlerdir. Ray sistemleri paslanmaz çelikten yapılır. Tüm malzemelerimiz TSE ve CE belgeli, 25 yıl garanti kapsamındadır.",
  },
  {
  ...
  },
  {
    ...
    answer: "Hebeshiebe için genellikle ruhsat gerekmez, ancak belediyenizin düzenlemelerine göre değişiklik gösterebilir. Projeniz için gerekli tüm izin ve ruhsat işlemlerinde size yardımcı oluyoruz.",
  },
  {
    question: "Hebeshiebe bakımı nasıl yapılır?",
...
export default function HebeshiebePage() {
  ...
  const jsonLd = {
    ...
    "@type": "Service",
    "serviceType": "Hebeshiebe Sistemleri",
    "provider": {
      "@type": "LocalBusiness",
      "name": "Kış Bahçesi",
      "address": {
            ...
            <div className="mx-auto max-w-7xl px-4 md:px-6">
              <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
                ...
                >
                  ...
                  >
                    15+ yıllık tecrübemiz ve 2500+ tamamlanan projemizle, evinize değer katacak modern hebeshiebe sistemleri sunuyoruz. Yukarı kaydırma sistemi, motorlu kontrol ve uzman montaj ekibimizle hayalinizdeki yaşam alanını gerçeğe dönüştürüyoruz.
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                  ...
                  >
                    <Link
                      href="https://wa.me/905333593466?text=Hebeshiebe%20hakkında%20bilgi%20almak%20istiyorum"
                      target="_blank"
            ...
            <div className="mx-auto max-w-7xl px-4 md:px-6">
              ...
              >
                ...
                <p className="mx-auto max-w-2xl text-lg text-gray-600">
                  Hebeshiebe sisteminiz, evinize değer katan ve yaşam kalitenizi artıran özel bir alan
                </p>
              </motion.div>
            ...
            <div className="mx-auto max-w-7xl px-4 md:px-6">
              ...
              >
                ...
                <p className="mx-auto max-w-2xl text-lg text-gray-600 md:text-xl">
                  15+ yıllık tecrübemizle tamamladığımız başarılı hebeshiebe projelerinden örnekler
                </p>
              </motion.div>

              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {hebeshiebeProjects.map((project, index) => (
                  <motion.div
                    key={project.title}
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                >
                  ...
                  <div className="relative w-full h-[90vh] bg-gray-100">
                    <Image
                      src={hebeshiebeProjects[selectedProject].src}
                      alt={hebeshiebeProjects[selectedProject].alt}
                      fill
          ...
          <section className="py-16 md:py-24 bg-gradient-to-b from-white via-teal-50/30 to-white">
            <div className="mx-auto max-w-4xl px-4 md:px-6">
              ...
              >
                ...
                <p className="mx-auto max-w-2xl text-lg text-gray-600 md:text-xl">
                  Hebeshiebe hakkında merak ettikleriniz ve cevapları
                </p>
              </motion.div>
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <Link
                    href="https://wa.me/905333593466?text=Hebeshiebe%20hakkında%20soru%20sormak%20istiyorum"
                    target="_blank"
