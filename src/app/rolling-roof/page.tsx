...
// Rolling roof kategorisindeki proje görselleri
const rollingRoofProjects = [
  { 
    src: "/images/projects/e672ed00-ee93-49eb-8ff6-5f95772ae59e.jpg", 
    title: "Modern Rolling Roof",
    alt: "Modern tasarım rolling roof projesi"
  },
  { 
    src: "/images/projects/7c30fee6-861f-4949-bd08-95dd9f9a16f2.jpg", 
    title: "Panoramik Rolling Roof",
    alt: "Panoramik görünümlü rolling roof"
  },
  { 
    src: "/images/projects/7920ba6f-b67e-47a0-9b09-5760f7bd139d.jpg", 
    title: "Villa Rolling Roof",
    alt: "Villa için özel tasarım rolling roof"
  },
  { 
    src: "/images/projects/110810ab-64f2-4728-a238-2a003508a302.jpg", 
    title: "Lüks Rolling Roof",
    alt: "Lüks rolling roof projesi"
  },
  { 
    src: "/images/projects/23423c76-bf9b-4e4d-9d1a-c6be73a68a50.jpg", 
    title: "Bahçe Entegrasyonlu Rolling Roof",
    alt: "Bahçe ile entegre rolling roof"
  },
  { 
    src: "/images/projects/24929279-47c0-4aad-b65f-f7ba24e86f5d.jpg", 
    title: "Premium Rolling Roof",
    alt: "Premium kalite rolling roof sistemi"
  },
];
...
const advantages = [
  {
    ...
    imageAlt: "Modern rolling roof tasarımı",
    title: "Açılır-Kapanır Tavan Sistemi",
    content: "Rolling roof sisteminiz, tamamen açılabilen ve kapanabilen bir tavan yapısına sahiptir. İstediğiniz zaman açık havada, istediğiniz zaman kapalı ve korunaklı bir alanda olabilirsiniz. Motorlu sistem sayesinde tek dokunuşla kontrol edebilirsiniz. Modern teknoloji ile konforlu ve esnek yaşam alanları yaratın.",
  },
  {
    image: "/images/projects/7c30fee6-861f-4949-bd08-95dd9f9a16f2.jpg",
    imageAlt: "Panoramik rolling roof görünümü",
    title: "Yıl Boyu Kullanılabilir Yaşam Alanı",
    content: "Rolling roof sisteminiz, yılın 12 ayı kullanabileceğiniz ekstra bir yaşam alanı kazandırır. Kış aylarında kapalı konumda korunaklı bir alan oluştururken, yaz aylarında tamamen açık konumda gökyüzünün altında vakit geçirebilirsiniz. Yağmur, kar ve güneşten korunurken, istediğiniz zaman doğayla iç içe olabilirsiniz.",
  },
  {
    image: "/images/projects/7920ba6f-b67e-47a0-9b09-5760f7bd139d.jpg",
    imageAlt: "Lüks rolling roof iç mekan",
    title: "Evinizin Değerini Artırır",
    content: "Profesyonel olarak tasarlanmış ve montaj edilmiş bir rolling roof sistemi, evinizin değerini önemli ölçüde artırır. Emlak değeri artışı yanında, yaşam kalitenizi de yükseltir. Yatırım olarak düşünüldüğünde, rolling roof uzun vadede size kazanç sağlar. Modern ve teknolojik görünümüyle evinizin çekiciliğini artırır.",
  },
  {
    image: "/images/projects/23423c76-bf9b-4e4d-9d1a-c6be73a68a50.jpg",
    imageAlt: "Bahçe entegrasyonlu rolling roof",
    title: "Doğayla İç İçe Yaşam",
    content: "Rolling roof sisteminiz, evinizle bahçeniz arasında köprü görevi görür. Tamamen açık konumda gökyüzünü izleyebilir, kapalı konumda korunaklı bir alan oluşturabilirsiniz. Doğayı içeriye taşıyarak, her mevsim yeşilliklerle çevrili bir ortam yaratır. Panoramik görünüm sayesinde manzaranın her köşesini net bir şekilde görebilirsiniz.",
  },
];

const faqData = [
  {
    question: "Rolling roof fiyatları ne kadar?",
    answer: "Rolling roof fiyatları, projenin büyüklüğüne, kullanılan malzemeye, motor tipine ve özel tasarım gereksinimlerine göre değişiklik gösterir. Standart bir rolling roof için fiyat aralığı 70.000 TL ile 300.000 TL arasında değişebilir. Detaylı fiyat teklifi için ücretsiz keşif hizmetimizden yararlanabilirsiniz.",
  },
  {
    question: "Rolling roof montajı ne kadar sürer?",
    answer: "Montaj süresi, projenin büyüklüğüne ve karmaşıklığına bağlı olarak 2-4 hafta arasında değişir. Standart bir rolling roof montajı genellikle 2-3 hafta içinde tamamlanır. Özel tasarım ve teknoloji entegrasyonu gerektiren projelerde bu süre biraz daha uzayabilir.",
  },
  {
    question: "Rolling roof hangi malzemelerden yapılır?",
    answer: "Rolling roof sistemlerimiz, 6063-T6 alaşımlı özel ekstrüzyon alüminyum profillerden üretilir. Tavan panelleri alüminyum veya cam malzemeden yapılabilir. Motorlar Avrupa standartlarında, sessiz ve güvenilir sistemlerdir. Tüm malzemelerimiz TSE ve CE belgeli, 25 yıl garanti kapsamındadır.",
  },
  {
    question: "Rolling roof nasıl çalışır?",
    answer: "Rolling roof sistemleri, elektrikli motorlar ile çalışır. Uzaktan kumanda, akıllı telefon uygulaması veya duvar anahtarı ile kontrol edilebilir. Sistem tamamen açılabilir veya kapanabilir. Güneş sensörleri sayesinde otomatik olarak güneşe göre ayarlanır. Yağmur sensörleri ile yağmur başladığında otomatik kapanır. Rüzgar sensörleri de güvenlik için eklenebilir.",
  },
  {
    question: "Rolling roof için ruhsat gerekir mi?",
    answer: "Rolling roof için genellikle ruhsat gerekmez, ancak belediyenizin düzenlemelerine göre değişiklik gösterebilir. Projeniz için gerekli tüm izin ve ruhsat işlemlerinde size yardımcı oluyoruz.",
  },
  {
    question: "Rolling roof bakımı nasıl yapılır?",
    answer: "Alüminyum profillerin bakımı çok kolaydır. Düzenli olarak su ve sabunlu bezle temizlenmesi yeterlidir. Motor sistemleri yılda bir kez profesyonel kontrol ve bakım gerektirir. Sensörlerin düzenli kontrolü önerilir. Ray sistemlerinin temiz tutulması önemlidir. Tüm bakım işlemleri için teknik destek ekibimiz hizmetinizdedir.",
  },
];
...
export default function RollingRoofPage() {
  ...
  const jsonLd = {
    ...
    "@type": "Service",
    "serviceType": "Rolling Roof Sistemleri",
    "provider": {
      "@type": "LocalBusiness",
      "name": "Kış Bahçesi",
      "address": {
            ...
            <div className="mx-auto max-w-7xl px-4 md:px-6">
              <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
                ...
                >
                  ...
                  >
                    Premium Rolling Roof Sistemleri
                  </motion.div>
                  <motion.h1
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                  ...
                  >
                    15+ yıllık tecrübemiz ve 2500+ tamamlanan projemizle, evinize değer katacak modern rolling roof sistemleri sunuyoruz. Açılır-kapanır tavan, akıllı sensörler ve uzman montaj ekibimizle hayalinizdeki yaşam alanını gerçeğe dönüştürüyoruz.
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                  ...
                  >
                    <Link
                      href="https://wa.me/905333593466?text=Rolling%20roof%20hakkında%20bilgi%20almak%20istiyorum"
                      target="_blank"
            ...
            <div className="mx-auto max-w-7xl px-4 md:px-6">
              ...
              >
                ...
                <p className="mx-auto max-w-2xl text-lg text-gray-600">
                  Rolling roof sisteminiz, evinize değer katan ve yaşam kalitenizi artıran özel bir alan
                </p>
              </motion.div>

              <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                {[
                  { icon: Zap, title: "Açılır-Kapanır Tavan", desc: "Tamamen açılabilen ve kapanabilen tavan sistemi" },
            ...
            <div className="mx-auto max-w-7xl px-4 md:px-6">
              ...
              >
                ...
                <p className="mx-auto max-w-2xl text-lg text-gray-600 md:text-xl">
                  15+ yıllık tecrübemizle tamamladığımız başarılı rolling roof projelerinden örnekler
                </p>
              </motion.div>

              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {rollingRoofProjects.map((project, index) => (
                  <motion.div
                    key={project.title}
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                >
                  ...
                  <div className="relative w-full h-[90vh] bg-gray-100">
                    <Image
                      src={rollingRoofProjects[selectedProject].src}
                      alt={rollingRoofProjects[selectedProject].alt}
                      fill
          ...
          <section className="py-16 md:py-24 bg-gradient-to-b from-white via-teal-50/30 to-white">
            <div className="mx-auto max-w-4xl px-4 md:px-6">
              ...
              >
                ...
                <p className="mx-auto max-w-2xl text-lg text-gray-600 md:text-xl">
                  Rolling roof hakkında merak ettikleriniz ve cevapları
                </p>
              </motion.div>
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <Link
                    href="https://wa.me/905333593466?text=Rolling%20roof%20hakkında%20soru%20sormak%20istiyorum"
                    target="_blank"
